...
2.  Instalar en el computador que va a usar:  
     a.  [Github Desktop](https://desktop.github.com/download). Para usar poder git desde su computador.  
     ...
     c.  [Python 3](https://www.python.org/downloads). Para poder generar las páginas web del material. Descargue la versión más actual (3.14 en este momento).
