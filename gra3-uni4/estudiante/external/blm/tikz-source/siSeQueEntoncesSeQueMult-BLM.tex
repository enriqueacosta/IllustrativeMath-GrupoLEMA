...
\node (tableTop) at ([yshift=-3ex]centerTop) {\includegraphics{siSeQueEntoncesSeQueMult-BLM-tab.pdf}};
\node (tableBot) at ([yshift=-3ex]centerBot) {\includegraphics{siSeQueEntoncesSeQueMult-BLM-tab.pdf}};
