...
\geometry{letterpaper, inner=1in, outer=0.3in, top=0.5in, bottom=0.7in}
...
\tcbset{ divisionexercisestyle/.style={bwminimalstyle, runintitlestyle, exercisespacingstyle, left=0.3cm, breakable, before upper app={\setlength{\parskip}{\medskipamount}} } }
\newtcolorbox{divisionexercise}[4]{divisionexercisestyle, before title={\hspace{-3ex}\makebox[3ex][r]{#1.\space}}, title={\notblank{#2}{#2\space}{}}, phantom={\label{#4}\hypertarget{#4}{}}, after={}}
...
\usepackage{enumitem}
\setlist{nosep, topsep=0pt, partopsep=0.3ex, left=0ex, parsep=1ex}
...
\NewTColorBox{sbspanel}{mO{top}}{sbspanelstyle,width=\linewidth,valign=#2, }
