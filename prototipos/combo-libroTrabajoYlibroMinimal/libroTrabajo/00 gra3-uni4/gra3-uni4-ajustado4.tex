\input{preamble-libroTrabajoGrado3-ajustado4.tex}
...
\includegraphics[scale=0.2, max width=\linewidth, center]{external/whitespace-tikz/1cm.pdf}
\end{image}%
%
\item{}\begin{image}{0}{1}{0}{}%
\includegraphics[scale=0.2, max width=\linewidth, center]{external/whitespace-tikz/1cm.pdf}
...
\end{activity}%
% \cleardoublepage
\begin{cutoutpage}[Clasificación de tarjetas: Todo sobre bichos]
...
\end{activity}%
% \cleardoublepage
\begin{cutoutpage}[Lección 8 - Actividad 1: Clasificación de tarjetas: Multiplicación]
Tarjetas para recortar:
\par
...
\end{activity}%
% \cleardoublepage
\begin{cutoutpage}[Lección 11 Actividad 2: Clasificación de tarjetas: Expresiones diferentes, mismo rectángulo]
\begin{image}{0}{1}{0}{}%
...
\end{activity}%
% \cleardoublepage
\begin{cutoutpage}[Lección 16 - Actividad 3: Juguemos “Cerca de 100, multiplicación”]
Tarjetas para recortar:
\begin{image}{0}{1}{0}{}%
...
\end{activity}%
% \cleardoublepage
\begin{cutoutpage}[Lección 20 - Actividad 3: “Compara: Divide hasta 100”]
Tarjetas para recortar%
\begin{image}{0}{1}{0}{}%
