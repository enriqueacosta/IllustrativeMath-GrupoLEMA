...
\end{enumerate}
\end{enumerate}
@@@@@ OJO @@@@: poner las tarjetas en su propia página para recortar con un \textbackslash{}cleardoublepage. Es posible que toque sacar los \textbackslash{}cleardoublepage y la instertada afuera del environment de la actividad.%
\par
...
Estas tarjetas para recortar tienen expresiones que representan áreas de rectángulos.%
\par
...
\par
@@@@@ OJO @@@@@@: asegurarse que toda la actividad, incluidas tarjetas, queden en una misma página y que la pagina quede como hoja para arrancar (impar, con hoja en blanco atrás). \begin{image}{0}{1}{0}{}%
