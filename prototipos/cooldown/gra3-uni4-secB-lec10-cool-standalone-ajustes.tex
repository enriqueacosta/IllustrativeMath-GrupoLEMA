...
\tcbset{ runintitlestyle/.style={fonttitle=\blocktitlefont\upshape\bfseries, attach title to upper, coltitle=Blue} }
...
\tcbset{ projectstyle/.style={bwminimalstyle, runintitlestyle, blockspacingstyle } }
...
% Indentación de párrrafos
\setlength{\parskip}{\smallskipamount}
\setlength{\parindent}{0pt}

% Márgenes
\usepackage{geometry}
\geometry{verbose,top=3.5cm,bottom=5cm,lmargin=2.5cm,rmargin=2.5cm,headheight=3cm,headsep=0.3cm,footskip=0cm}
...
\fancyhead[C]{\begin{tikzpicture}[remember picture,overlay] \node[yshift=-3.1cm] at (current page.north west) {\begin{tikzpicture}[remember picture, overlay] \includegraphics[width=\paperwidth]{GrupoLEMA.png}\end{tikzpicture}};\end{tikzpicture}} % Paper-Wide header
\fancyfoot[L]{{\small Copyright Grupo LEMA (www.grupolema.org), \the\year{}. Licencia de uso CC-BY-NC Internacional 4.0.\\
{ \scriptsize Detalles de licencia en https://creativecommons.org/licenses/by/4.0/deed.es\\
Adaptado de IM K–5 Math v.I, © 2021 Illustrative Mathematics ® illustrativemathematics.org en su versión en español en im.kendallhunt.com, distribuido con una licencia Creative Commons Attribution 4.0 International License (CC BY 4.0). Ver detalles de esta licencia en https://creativecommons.org/licenses/by/4.0/.
Soluciones en español adaptadas de Open Up Resources © 2022, openupresources.org. Publicadas bajo una licencia Creative Commons Attribution-NonCommercial 4.0 International license.}
}}
\fancyhead[R]{}
\fancyfoot[R]{\thepage}
...
\usepackage[none]{hyphenat} %para que no parta palabras
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[max width=\linewidth, center]{svg-source/tikz-file-153042.pdf}
\end{sbspanel}%
\end{sidebyside}%
...
% \end{sbspanel}%
% \begin{sbspanel}{0.35}%
% \includegraphics[max width=\linewidth]{svg-source/tikz-file-153041.pdf}
% \end{sbspanel}%
% \begin{sbspanel}{0.35}%
% \includegraphics[max width=\linewidth]{svg-source/tikz-file-176321.pdf}
% \end{sbspanel}%
% \end{sidebyside}%
% %
