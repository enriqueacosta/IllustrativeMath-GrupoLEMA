...
\fancyhead[C]{\begin{tikzpicture}[remember picture,overlay] \node[yshift=-3.1cm] at (current page.north west) {\begin{tikzpicture}[remember picture, overlay] \includegraphics[width=\paperwidth]{Header.png}\end{tikzpicture}};\end{tikzpicture}} % Paper-Wide header
