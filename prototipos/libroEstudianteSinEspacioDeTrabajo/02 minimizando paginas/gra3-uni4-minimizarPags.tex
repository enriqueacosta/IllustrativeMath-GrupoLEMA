\input{preamble-libroEstGrado3-minimizarPags.tex}
...
% \includegraphics[max width=0.8\linewidth, center]{external/png-source/v1 3.4.A5 Launch.png}
% \end{image}%
%
\begin{enumerate}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=0.9\linewidth, center]{external/tikz-source/enElMercadoAgricola-tab.pdf}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
\end{multicols}
...
\end{enumerate}
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=0.5\linewidth, center]{external/tikz-source/siSeQueEntoncesSeQue-tab.pdf}
\end{image}%
% Ver libro de trabajo.
\end{activity}%
\end{subsubsectionptx}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=0.5\linewidth, center]{external/tikz-source/siSeQueEntoncesSeQueMult-tab.pdf}
\end{image}%
...
\vfill\columnbreak
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=0.8\linewidth, center]{external/tikz-source/unaGranCantidadDeDolares-tab1.pdf}
\end{image}%
\hfill(llenar aparte)
\end{multicols}
...
\vfill\columnbreak
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=0.5\linewidth, center]{external/tikz-source/unaGranCantidadDeDolares-tab2.pdf}
\end{image}%
\hfill(llenar aparte)
\end{multicols}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=0.6\linewidth, center]{external/tikz-source/expolacionEstimacion-tab-gra3.pdf}
\end{image}%
\end{multicols}
\end{exploration}%
\end{subsubsectionptx}
...
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[max width=0.8\linewidth, center]{external/png-source/egg_carton.png}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
