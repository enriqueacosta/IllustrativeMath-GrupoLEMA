...
\begin{image}{0}{1}{0}{}%
\includegraphics[ width=0.65\linewidth, center]{external/svg-source/tikz-file-148146.pdf}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
\begin{sbspanel}{0.3}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-153034.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-153035.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-153036.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{exploration}%
\end{subsubsectionptx}
