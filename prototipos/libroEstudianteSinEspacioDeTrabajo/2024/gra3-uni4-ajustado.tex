...
% \newenvironment{project}[3]{\comment}{\endcomment}
%%
%% tcolorbox, with styles, for GOAL-LIKE
%%
%% objectives: early in a subdivision, introduction/list/conclusion
\tcbset{ objectivesstyle/.style={bwminimalstyle, blockspacingstyle, fonttitle=\blocktitlefont\large\bfseries, fontupper={}, toprule=0ex, toptitle=0ex, top=0ex, bottom=0.5ex, bottomrule=0.1ex} }
\newtcolorbox{objectives}[2]{title={}, phantomlabel={#2}, breakable, before upper app={\setlength{\parindent}{0pt}}, objectivesstyle}
%%
...
A.%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151669.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
B.%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151670.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151673.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
\begin{image}{0.15}{0.7}{0.15}{-0.8\baselineskip}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147480.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\includegraphics[width=0.5\linewidth, max width=\linewidth, center]{external/png-source/CS 3.4 Lesson 7 Activity 1.png}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
¿Qué observas? ¿Qué te preguntas?%
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152968.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152978.pdf}
\end{image}%
%
\begin{enumerate}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=0.9, max width=\linewidth, center]{external/tikz-source/siSeQueEntoncesSeQueMult-tab.pdf}
\end{image}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-153040.pdf}
\end{image}%
\end{project}%
\end{reading-questions-subsubsection}
\end{subsectionptx}
...
B%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-153082.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.05}{0.05}{0.1}%
\begin{sbspanel}{0.4}%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-158678.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{project}%
\end{reading-questions-subsubsection}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151677.pdf}
\end{image}%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-159147.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
¿Qué observas? ¿Qué te preguntas?%
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149355.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149356.pdf}
\end{image}%
%
\begin{itemize}[label=\textbullet]
...
\begin{sidebyside}{3}{0}{0}{0}%
\begin{sbspanel}{0.333333333333333}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149346.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.333333333333333}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149347.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.333333333333333}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-141822.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{exploration}%
\end{subsubsectionptx}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-141823.pdf}
\end{image}%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147551.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.05}{0.4}{0.05}%
\begin{sbspanel}{0.1}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147552.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.05}{0.4}{0.05}%
\begin{sbspanel}{0.1}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147553.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147479.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{project}%
\end{reading-questions-subsubsection}
...
A%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149350.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
B%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149351.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
C%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149352.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
D%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149353.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{exploration}%
\end{subsubsectionptx}
...
Clare%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152969.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
Andre%
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152970.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152971.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0.3}{0.05}%
\begin{sbspanel}{0.05}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152972.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0.3}{0.05}%
\begin{sbspanel}{0.05}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152973.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0.3}{0.05}%
\begin{sbspanel}{0.05}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152974.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151678.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
%
\begin{enumerate}[label=(\alph*)]
...
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151679.pdf}
\end{image}%
%
\begin{enumerate}[label=(\alph*)]
...
\begin{sidebyside}{2}{0.025}{0.025}{0.05}%
\begin{sbspanel}{0.45}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151680.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.45}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-151681.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}[label=(\alph*)]
...
\end{sbspanel}%
\begin{sbspanel}{0.7}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147742.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.0375}{0.0375}{0.075}%
\begin{sbspanel}{0.15}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.7}[center]%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-141827.pdf}
\par
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-158683.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{references-subsection}
\end{sectionptx}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152963.pdf}
\end{image}%
Este es el trabajo de Han:%
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-152964.pdf}
\end{image}%
%
\begin{enumerate}
...
\par
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149344.pdf}
\end{image}%
%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-149345.pdf}
\end{image}%
\begin{image}{0}{1}{0}{}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, center]{external/svg-source/tikz-file-147697.pdf}
\end{image}%
