...
% \tcbset{ bwminimalstyle/.style={size=minimal, boxrule=-0.3pt, ,
% colback=orange!20, colbacktitle=orange, coltitle=black, opacityfill=0.0} }
...
\geometry{letterpaper,total={450pt,9.5in}}
...
%% Environment for a PTX "solutions" at the level of a LaTeX "section"
\NewDocumentEnvironment{solutions-section}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
%% Environment for a PTX "solutions" at the level of a LaTeX "section"
\NewDocumentEnvironment{solutions-section-numberless}{mmmmmmm}
{%
\renewcommand{\divisionnameptx}{#1}%
\renewcommand{\titleptx}{#2}%
\renewcommand{\subtitleptx}{#3}%
...
\tcbset{ explorationsolutionstyle/.style={bwminimalstyle, runintitlestyle, exercisespacingstyle, after title={\space}, breakable, before upper app={\setlength{\parindent}{\normalparindent}} } }
...
\tcbset{ divisionexercisestyle/.style={bwminimalstyle, runintitlestyle, exercisespacingstyle, left=5ex, breakable, before upper app={} } }
...
\usepackage{enumitem}
\setlist{nosep, topsep=0pt, partopsep=1ex, parsep=1ex}
...
\tcbset{ explorationstyle/.style={, , blockspacingstyle, after title={\space}, before upper app={\setlength{\parskip}{\medskipamount}}, colback=purple!5, colbacktitle=purple!70, coltitle=white, } }
...
\tcbset{ activitystyle/.style={, , blockspacingstyle, after title={\space}, before upper app={\setlength{\parskip}{\medskipamount}}, colback=orange!5, colbacktitle=orange!95!black!80, coltitle=white, } }
...
\tcbset{ projectstyle/.style={, , blockspacingstyle, after title={\space}, before upper app={\setlength{\parskip}{\medskipamount}}, colback=teal!5, colbacktitle=teal!70, coltitle=white,  } }
...
\tcbset{ objectivesstyle/.style={bwminimalstyle, blockspacingstyle, fonttitle=\blocktitlefont\bfseries, toprule=0.1ex, toptitle=0.5ex, top=2ex, bottom=0.5ex, bottomrule=0.1ex} }
...
\tcbset{ sbsstyle/.style={raster before skip=1.0ex, raster equal height=rows, raster force size=false} }
...
\fancyhead[R]{}
% \fancyfoot[R]{}
\fancyfoot[LO, RE]{\textcolor{PineGreen}{\textbf{\thepage}}}
% \fancyfootoffset{2cm}
...
%
\typeout{************************************************}
\typeout{Subsubsección  Actividad de cierre}
\typeout{************************************************}
%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[width=0.8\linewidth, max width=\linewidth, center]{external/jpg-source/3.4.A2 Warrm-up.jpg}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
A%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/tikz-source/tikz-file-149310.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
B%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/tikz-source/tikz-file-149311.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{activity}%
\end{subsubsectionptx}
...
A.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149313.pdf}
B.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149314.pdf}
C.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149315.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{activity}%
\end{subsubsectionptx}
...
A.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-246306.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
B.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-246307.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{project}%
\end{subsubsectionptx}
...
\begin{sbspanel}{0.2}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/V1 3.4.A.4 Mexican Trompo.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.2}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/V1 3.4.A.4 Dreidels.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.2}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/V1 3.4.A.4 Indonesian Gasing.jpg}
\end{sbspanel}%
\begin{sbspanel}{0.2}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/V1 3.4.A.4 German Kreisel Copy.png}
\end{sbspanel}%
\begin{sbspanel}{0.2}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/V1 3.4.A.4 Colorful Top.jpg}
\end{sbspanel}%
\end{sidebyside}%
\par
...
A%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149316.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.4}%
B%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149317.pdf}
\end{sbspanel}%
\end{sidebyside}%
\par
Expresiones%
...
\end{sbspanel}%
\begin{sbspanel}{0.45}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151100.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.02}%
B%
\end{sbspanel}%
\begin{sbspanel}{0.45}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151101.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{4}{0.0075}{0.0075}{0.015}%
\begin{sbspanel}{0.02}%
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/v1 3.4.A5 Launch.png}
\end{image}%
\tcblower
\end{figureptx}%
%
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151668.pdf}
\end{sbspanel}%
...
A.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151669.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
B.%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151670.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151673.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
\end{sbspanel}%
\begin{sbspanel}{0.95}%
\includegraphics[scale=1.0, max width=\linewidth, center]{external/svg-source/tikz-file-151671.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.05}%
...
\end{sbspanel}%
\begin{sbspanel}{0.95}%
\includegraphics[scale=1.0, max width=\linewidth, center]{external/svg-source/tikz-file-151672.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{enumerate}
%
...
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151674.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.02}%
B%
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151675.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.02}%
C%
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151676.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
\begin{sidebyside}{2}{0.025}{0.025}{0.05}%
\begin{sbspanel}{0.45}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147695.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.45}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147696.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.025}{0.025}{0.05}%
\begin{sbspanel}{0.45}%
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3.4.B6 Act 1 Launch.jpg}
\end{image}%
...
\multicolumn{1}{Am{0.4\linewidth}A}{\raggedright%
La familia de Elena compra 18 aguacates en el mercado agrícola. Hay 3 aguacates en cada bolsa.%
}&\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/tikz-source/tikz-file-3-4-B-131870.pdf}
\end{image}%
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/tikz-source/tikz-file-3-4-B-131871.pdf}
\end{image}%
&\(2 \times{ ?} = 6\)&\tabularnewline\hrulethin
&\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/tikz-source/tikz-file-3-4-B-131872.pdf}
\end{image}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147480.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/CS 3.4 Lesson 7 Activity 1.png}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
\multicolumn{1}{Am{0.4\linewidth}A}{\raggedright%
\textendash{}%
}&\multicolumn{1}{m{0.6\linewidth}A}{\raggedright%
\textendash{}%
...
¿Qué observas? ¿Qué te preguntas?%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152968.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152978.pdf}
\end{image}%
%
\begin{enumerate}
...
\typeout{************************************************}
%
\begin{subsubsectionptx}{Subsubsección}{Actividad de cierre}{}{Actividad de cierre}{}{}{gra3-uni4-secB-lec9-cool}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153040.pdf}
\end{image}%
\end{project}%
\end{subsubsectionptx}
\end{subsectionptx}
...
%
\begin{itemize}[label=\textbullet]
\item{}Usemos rectángulos para explorar estrategias de multiplicación.%
\end{itemize}
\end{objectives}
%
%
...
¿Cuántos ves? ¿Cómo lo sabes?, ¿qué ves?%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147481.pdf}
\end{image}%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-141805.pdf}
\end{image}%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147478.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153043.pdf}
\end{sbspanel}%
\end{sidebyside}%
...
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153044.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.25}%
...
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153045.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.25}%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153048.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
Noah%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153051.pdf}
%
\begin{equation*}
(5\times 3)+(2 \times 3)
\end{equation*}
...
Priya%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153053.pdf}
%
\begin{equation*}
2 \times (2 \times 6)
\end{equation*}
...
Tyler%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153054.pdf}
%
\begin{equation*}
(5 \times 8) + (3 \times 8)
\end{equation*}
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153042.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{project}%
\end{subsubsectionptx}
...
A%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153081.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.4}%
B%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153082.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.05}{0.05}{0.1}%
\begin{sbspanel}{0.4}%
...
D%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153083.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{exploration}%
\end{subsubsectionptx}
...
A%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153084.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.261}%
B%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153085.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.348}%
C%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-153086.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{activity}%
\end{subsubsectionptx}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/Card Sort Different Expressions, Same Rectangle for Screenshot Only.png}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-158678.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{project}%
\end{subsubsectionptx}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151677.pdf}
\end{image}%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-159147.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{divisionexercise}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.0, max width=\linewidth, center]{external/svg-source/tikz-file-176322.pdf}
\end{image}%
\begin{sidebyside}{3}{0}{0}{0}%
...
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-141807.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}[center]%
\(7\times 3\)\\
 \((5\times3)+(2\times3)\)%
...
¿Qué observas? ¿Qué te preguntas?%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149355.pdf}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149356.pdf}
\end{image}%
%
\begin{itemize}[label=\textbullet]
...
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/egg_carton.png}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\begin{sidebyside}{3}{0}{0}{0}%
\begin{sbspanel}{0.333333333333333}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149346.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.333333333333333}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149347.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.333333333333333}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-141822.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{exploration}%
\end{subsubsectionptx}
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-141823.pdf}
\end{sbspanel}%
\end{sidebyside}%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147551.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.05}{0.4}{0.05}%
\begin{sbspanel}{0.1}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147552.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.05}{0.4}{0.05}%
\begin{sbspanel}{0.1}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.4}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147553.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147479.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{project}%
\end{subsubsectionptx}
...
A%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149350.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
B%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149351.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
C%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149352.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
D%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149353.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{exploration}%
\end{subsubsectionptx}
...
Clare%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152969.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.5}%
Andre%
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152970.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152971.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0.3}{0.05}%
\begin{sbspanel}{0.05}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152972.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0.3}{0.05}%
\begin{sbspanel}{0.05}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152973.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0}{0.3}{0.05}%
\begin{sbspanel}{0.05}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152974.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/CS 3.4 Lesson 16 Activity 2.png}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\end{sbspanel}%
\begin{sbspanel}{0.4}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/CS 3.4 Lesson 17.png}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151678.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.6}[center]%
%
\begin{enumerate}[label=(\alph*)]
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151679.pdf}
\end{image}%
%
\begin{enumerate}[label=(\alph*)]
...
\begin{sidebyside}{2}{0.025}{0.025}{0.05}%
\begin{sbspanel}{0.45}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151680.pdf}
\end{sbspanel}%
\begin{sbspanel}{0.45}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-151681.pdf}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}[label=(\alph*)]
...
\end{sbspanel}%
\begin{sbspanel}{0.7}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147742.pdf}
\end{sbspanel}%
\end{sidebyside}%
\begin{sidebyside}{2}{0.0375}{0.0375}{0.075}%
\begin{sbspanel}{0.15}[center]%
...
\end{sbspanel}%
\begin{sbspanel}{0.7}[center]%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-141827.pdf}
\par
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-158683.pdf}
\end{sbspanel}%
\end{sidebyside}%
\end{references-subsection}
\end{sectionptx}
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/CS 3.4 Lesson 18 Activity 1.png}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
\end{sbspanel}%
\begin{sbspanel}{0.2}%
\includegraphics[scale=1.0, max width=\linewidth, center]{external/png-source/CS 3.4 Lesson 19 Activity 1.png}
\end{sbspanel}%
\end{sidebyside}%
\end{activity}%
\end{subsubsectionptx}
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152963.pdf}
\end{image}%
Este es el trabajo de Han:%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-152964.pdf}
\end{image}%
%
\begin{enumerate}
...
\par
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149344.pdf}
\end{image}%
%
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-149345.pdf}
\end{image}%
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/tikz-source/3-4-21-act1-tab.pdf}
\end{image}%
\begin{image}{0.25}{0.5}{0.25}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/png-source/3.4.D21.S_Sp.png}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
\begin{image}{0.25}{0.5}{0.25}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/apple-3535566_1920.jpg}
\end{image}%
%
\begin{enumerate}
...
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22-warm-garden-934189_1920.jpg}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22 Act1-Fresas.jpg}
\end{sbspanel}%
\end{sidebyside}%
%
\begin{enumerate}
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22 Act2-melon-cantalupo.jpg}
%
\par
melones cantalupos%
%
...
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22 Act2-calabacin.jpg}
%
\par
calabacín%
%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22 Act2-tomate.jpg}
%
\par
tomates%
%
...
\begin{sidebyside}{2}{0}{0}{0}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22 Act2-frijoles-pintos.jpg}
%
\par
frijoles pintos%
%
...
\end{sbspanel}%
\begin{sbspanel}{0.5}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/jpg-source/3-4-D-22 Act2-papas.jpg}
%
\par
papas%
%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[scale=1.3, max width=\linewidth, center]{external/svg-source/tikz-file-147697.pdf}
\end{image}%
