...
\tcbset{ sbsstyle/.style={raster before skip=0.5ex, raster equal height=rows, raster force size=false, } }
...
\begin{image}{0}{1}{0}{}%
\includegraphics[width=1.1\linewidth, center]{external/blm/tikz-source/todoSobreBichos-tarjetas.pdf}
\end{image}%
\end{activity}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, scale=0.5, center]{external/whitespace-tikz/1cm.pdf}
\end{image}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[max width=\linewidth, scale=1.5, center]{external/whitespace-tikz/4cm.pdf}
\end{image}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[width=1.0\linewidth, center]{external/blm/tikz-source/enElMercadoAgricola-blm-tab.pdf}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
\end{activity}%
\includegraphics[trim=70 70 60 160,clip, width=1.0\linewidth]{external/blm/tikz-source/clasificacionTarjetas-mult-blm-hojaRegistro.pdf}
