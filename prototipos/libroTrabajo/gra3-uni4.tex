...
\begin{image}{0}{1}{0}{}%
\includegraphics[width=\linewidth]{external/blm/tikz-source/todoSobreBichos-tarjetas.pdf}
\end{image}%
\end{activity}%
...
\begin{image}{0}{1}{0}{}%
\includegraphics[width=\linewidth]{external/blm/tikz-source/enElMercadoAgricola-blm-tab.pdf}
\end{image}%
\end{activity}%
\end{subsubsectionptx}
%
...
@@@@@@ OPCIÓN 1 @@@@@@: dejar acá nota que hay que insertar con pdfpages los BLMS: clasificacionTarjetas-mult-blm-hojaRegistro.pdf y clasificacionTarjetas-multiplicacion-blm.pdf. Usar \mono{\textbackslash{}includepdf[pages=-,pagecommand=\{\}]} para que los pdf hereden los encabezados, números de página, etc. Habría que dejar acá un mensaje con los commandos que hay que ejecutar en el latex para que estos se ajusten en paginación. Esos includepdf tienen que estar afuera del tcolorbox de activity, porque no funciona bien con eso. Habría que dejar un mensaje para el estudiante diciendo que las páginas que siguen son para esa actividad.%
\par
@@@@@@ OPCIÓN 2 @@@@@: Crear pseudo-código pretext que se incluye a continuación, que incluye partes que se usan para crear los blm en pdf, y que habría que arreglar a mano en la paginación del libro de trabajo.%
\par
Tarjetas para recortar:%
\par
@@@@ WARNING @@@@ : una imagen por página, y después vienen las instrucciones en nueva página.%
\begin{image}{0}{1}{0}{}%
\includegraphics[width=\linewidth]{external/blm/tikz-source/clasificacionTarjetas-multiplicacion-tarjetas1.pdf}
\end{image}%
Tarjetas para recortar:%
\par
@@@@ WARNING @@@@ : una imagen por página, y después vienen las instrucciones en nueva página.%
\begin{image}{0}{1}{0}{}%
\includegraphics[width=\linewidth]{external/blm/tikz-source/clasificacionTarjetas-multiplicacion-tarjetas2.pdf}
\end{image}%
@@@@ WARNING @@@@ : una imagen por página, y después vienen las instrucciones en nueva página.%
\par
...
\begin{image}{0}{1}{0}{}%
\includegraphics[width=\linewidth]{external/blm/tikz-source/siSeQueEntoncesSeQueMult-BLM-tab.pdf}
\end{image}%
