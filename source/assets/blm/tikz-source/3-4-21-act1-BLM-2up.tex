...
\node (tableTop) at ([yshift=-8ex]centerTop) {\includegraphics{../../tikz-source/3-4-21-act1-BLM-table.pdf}};
\node (tableBot) at ([yshift=-8ex]centerBot) {\includegraphics{../../tikz-source/3-4-21-act1-BLM-table.pdf}};
