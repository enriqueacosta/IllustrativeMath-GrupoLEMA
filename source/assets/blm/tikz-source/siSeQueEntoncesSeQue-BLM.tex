...
\node[below right] at (topLeft) {\bf Si sé que ..., entonces sé que ...};
\node[below right] at (midLeft) {\bf Si sé que ..., entonces sé que ...};


% Espacio de nombre
\node[below left] at ([yshift=-4ex]topRight) {Nombre: \underline{\hspace{6cm}}};
\node[below left] at ([yshift=-4ex]midRight) {Nombre: \underline{\hspace{6cm}}};
