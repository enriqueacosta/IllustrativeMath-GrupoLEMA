...
\node (tableTop) at (centerTop) {\includegraphics{siSeQueEntoncesSeQueMult-BLM-tab.pdf}};
\node (tableBot) at (centerBot) {\includegraphics{siSeQueEntoncesSeQueMult-BLM-tab.pdf}};
