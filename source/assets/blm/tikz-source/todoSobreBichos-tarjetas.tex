...
\tikzstyle{tarjeta}=[%
    ...
    , text width = 2.8in     % min width     
    , minimum height = 2in % min height
...
\def\textoTarejetaA{El grillo topo tiene unas patas especiales para cavar. Diez patas especiales pertenecen a 5 grillos topo. ¿Cuántas patas especiales tiene cada grillo topo?}
...
\def\textoTarejetaC{Catorce antenas pertenecen a un grupo de abejas. Si cada abeja tiene 2 antenas, ¿cuántas abejas hay?}
\def\textoTarejetaD{Hay 12 alas. Si cada libélula tiene 4 alas, ¿cuántas libélulas hay?}
\def\textoTarejetaE{Treinta patas pertenecen a 5 hormigas. Si todas las hormigas tienen el mismo número de patas, ¿cuántas patas tiene cada hormiga?}
