...
\node[anchor=north] (table1) at ([yshift=-5ex]centerTop) {\includegraphics[scale=0.95]{unaGranCantidadDeDolares-blm-tab1.pdf}};
\node[anchor=north] (table2) at ([yshift=-1ex]table1.south) {\includegraphics[scale=0.95]{unaGranCantidadDeDolares-blm-tab2.pdf}};
