...
\NewTColorBox{tcbimage}{mmm}{imagestyle,left=0pt, top=0ex, width=#2\linewidth}
...
\tcbset{ bwminimalstyle/.style={blank, fonttitle=\bfseries\LARGE, colback=white, before upper = {\setlength{\parskip}{\medskipamount}\vspace{0.1cm} }} }
...
\tcbset{ projectstyle/.style={bwminimalstyle, blockspacingstyle, after title={\space}, bottomtitle=1cm } }
...
\fancyfoot[L]{{\scriptsize Grupo LEMA (www.grupolema.org), \the\year{}. Licencia de uso CC-BY-NC Internacional 4.0.}\\{\tiny Adaptado de IM K–5 Math v.I, © 2021 Illustrative Mathematics ® illustrativemathematics.org en su versión en español en im.kendallhunt.com y de Open Up Resources © 2022,\\[-0.35cm] openupresources.org, publicadas bajo una licencia Creative Commons CC BY 4.0. Detalles: https://creativecommons.org/licenses/by/4.0/deed.es}}
...
\title{Matemáticas IM\textsuperscript{\textregistered} + LEMA}
\date{}