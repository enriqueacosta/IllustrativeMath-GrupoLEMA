...
\tcbset{ bwminimalstyle/.style={blank, fonttitle=\bfseries\LARGE, bottomtitle=1cm, after title={\space}, colback=white, before upper = {\setlength{\parskip}{\medskipamount}\vspace{0.1cm} }} }
...
\tcbset{ projectstyle/.style={bwminimalstyle, blockspacingstyle,  } }
...
\tcbset{ activitystyle/.style={bwminimalstyle, blockspacingstyle,   } }
