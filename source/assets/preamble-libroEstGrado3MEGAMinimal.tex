...
\newcommand{\includeGraphicsIfNotFirst}{%
  \ifdim\pagetotal=0pt
    % Do nothing if at the top of a new page
  \else
    \noindent
    \ifodd\value{page}%
        \hspace*{-1.2in} % For odd pages
    \else
        \hspace*{-0.7in} % For even pages
    \fi
    \includegraphics[width=\paperwidth]{external/png-source/barra-colorGrupoLEMA.pdf}%
  \fi
}
